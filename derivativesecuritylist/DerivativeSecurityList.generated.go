...
func (m DerivativeSecurityList) SetTotalNumSecurities(v int) {
...
func (m DerivativeSecurityList) GetTotalNumSecurities() (v int, err quickfix.MessageRejectError) {
...
func (m DerivativeSecurityList) HasTotalNumSecurities() bool {
